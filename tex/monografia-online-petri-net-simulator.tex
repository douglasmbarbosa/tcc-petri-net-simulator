...
\renewcommand{\lstlistlistingname}{Lista de Scripts} % Renomeia o título da lista
\lstlistoflistings % Gera a lista de scripts
...
\begin{figure}[h!]
	...
	\end{tikzpicture}
	\caption{Diagrama de fluxo para criar um lugar}
...
\begin{figure}[ht] 
	...
	\caption[Clicando bo botao addPlace]{Clique no botão \textit{\textbf{addPlace}}}
