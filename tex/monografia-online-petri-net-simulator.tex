...
A função \textbf{\textit{deleteNet()}} retorna todas as variáveis, que compõem a rede de Petri, para seu valor inicial, zero ou vazio. Além disso, ela limpa o \textbf{\textit{localStorage}} \ref{cap:saveLoadNet}, eliminando os dados salvos na memória do navegador. 
