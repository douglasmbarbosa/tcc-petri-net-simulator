...
O evento \textbf{\textit{mousemove}} é disparado sempre que ocorre o movimento do ponteiro do mouse sobre um determinado elemento. No caso da aplicação web desenvolvida, é acionado sempre que ocorre o movimento do ponteiro do mouse sobre a área delimitada para o desenvolvimento da rede de Petri. 

As propriedades \textbf{\textbf{clientX}} e \textbf{\textit{clientY}} permitem definir a posição do ponteiro do mouse sempre que ele está se movendo. A última posição detectada pelo evento é a do cursor. Utiliza-se desse evento, principalmente, para determinar se o cursor está sobre um dos elementos clicáveis na tela. Caso sim, ele altera o design do ponteiro, conforme imagem. 
