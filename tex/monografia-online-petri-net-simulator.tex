...
O HTML5 fornece o elemento \textbf{<canvas>}, que permite o desenvolvimento de figuras geométricas, gráficos e textos. No contexto desse projeto, o elemento \textbf{<canvas>} foi essencial. Primeiramente, fornecendo uma área na tela para o desenvolvimento e manipulação das redes de Petri. Posteriormente, fornecendo uma API que pode ser manipulada, através do JavaScript, para a criação de elementos gráficos. 
...
Explicar o canvas
Falar da funcao loop ()
Falar da funçào render ()
