...
Para renderizar um lugar é importante entender que ele, nada mais é, que um circulo. Ao manipular o \textbf{canvas} é possível construir um circulo passando as posições \textbf{x} e \textbf{y} e o seu raio. 
